...
Графики представлены в поддиректориях `tests/plots/.../arm/`.
...
Графики представлены в [данной директории](https://github.com/qrutyy/bmp-conv/blob/main/tests/plots/1226x2001/x86-64/).
...
Графики представлены в [данной директории](https://github.com/qrutyy/bmp-conv/blob/main/tests/plots/1242x1227/x86-64/).
...
Из-за того, что на графике [графике](https://github.com/qrutyy/bmp-conv/blob/main/tests/plots/sw-1242x1227/x86-64/filter_pairs_execution_time.png) значения выглядят искусственно равными - снизу представлены более детальные данные на 95% доверительном интервале с точностью до десятитысячных:
